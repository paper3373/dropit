# Clone from https://github.com/facebookresearch/deit

To train DeiT-Ti with DropIT on ImageNet-1k, run

```
torchrun --standalone --nnodes=1 --nproc_per_node=8 main.py --model deit_tiny_patch16_224 --batch-size 512 --data-path /path/to/imagenet --output_dir outputs/deit_t_nsigmax0.6
```
